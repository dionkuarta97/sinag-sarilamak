            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <?= form_open_multipart('Rutilahu/edit/' . $value['id_mstr']) ?>
                        ...
                        <div class="form-group">
                            ...
                            <input value="RUTILAHU" type="text" name="kategori" id="kategori" class="form-control" placeholder="Masukkan Tempat Lahir">
