            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <?= form_open_multipart('Keluar/edit/' . $value['id_mstr']) ?>
                        ...
                        <div class="form-group">
                            ...
                            <input value="Keluar" type="hidden" name="stts_hidup" id="stts_hidup" class="form-control" placeholder="Masukkan Tempat Lahir">

                        </div>
                        <div class="form-group">
                            <label for="tgl_mmp">Tanggal Keluar</label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="alamat_astj" id="alamat_astj" class="form-control" placeholder="Masukkan Alamat Tujuan">

                        </div>
                        <div class="form-group">
                            <label for="keg_astj">Keg/Kel Tujuan</label>
                            <input type="text" name="keg_astj" id="keg_astj" class="form-control" placeholder="Masukkan Keg/Kel Tujuan">
